...
def select_shallow_thinking_agent(provider) -> str:
    ...
    SHALLOW_AGENT_OPTIONS = {
        ...
        "google": [
            (
                "Gemini 3 Flash Preview - Most advanced fast model (Recommended)",
...
def select_deep_thinking_agent(provider) -> str:
    ...
    DEEP_AGENT_OPTIONS = {
        ...
        "google": [
            (
                "Gemini 3 Pro Preview - Most advanced reasoning, 1M context (Recommended)",
                "gemini-3-pro-preview",
            ),
            (
                "Gemini 3 Flash Preview - Fast with advanced capabilities",
                "gemini-3-flash-preview",
            ),
        ...
        "vertex": [
            ...
            ("Gemini 2.5 Pro - State-of-the-art reasoning", "gemini-2.5-pro"),
            (
                "Gemini 2.5 Flash - Adaptive thinking, cost efficiency",
                "gemini-2.5-flash",
            ),
...
def select_llm_provider() -> tuple[str, str]:
    ...
    BASE_URLS = [
        ...
        ("Vertex", None),  # Uses GCP Application Default Credentials
